...
const EditResource = () => {
    ...
    const handleSubmit = async (data) => {
        ...
        setError('');
        try {
            await axiosInstance.put(`/api/resources/${id}`, data);
    ...
    if (fetching) return <p className="text-gray-500 text-sm">Loading...</p>;

    return (
        <div>
            <div className="flex items-center gap-2 text-sm text-gray-500 mb-5">
                <Link to="/admin/resources" className="hover:text-gray-700">Resources</Link>
                <span>/</span>
                <span className="text-gray-800 font-medium">Edit Resource</span>
            </div>
